...
public class AccessTokenTest {
    ...
    @Test
    public void when_created_plus_expiresIn_greater_than_current_time_return_false()
            throws Exception {
        // GIVEN
    ...
    @Test
    public void when_created_plus_expiresIn_less_than_current_time_return_true() throws Exception {
        // GIVEN
        AccessToken accessToken = spy(new AccessToken("Bearer", "899", "basic", false, "1800"));
        Calendar cal = Calendar.getInstance();
        cal.setTime(new Date(System.currentTimeMillis()));
        ...
        Long created = cal.getTimeInMillis();
        doReturn(created).when(accessToken).getCreated();
        doReturn("899").when(accessToken).getExpiresIn();
    ...
    @Test
    public void when_refresh_token_duration_more_than_now_return_false() throws Exception {
        // GIVEN
    ...
    public void when_refresh_token_duration_greater_than_now_return_true() throws Exception {
        ...
        // THEN
        assertEquals(accessToken.getRefreshExpiresIn(), "600");
        assertTrue(expired);
    }
    ...
    public void when_no_refresh_expires_in_set_it_to_expires_in() throws Exception {
        ...
        // THEN
        assertEquals(accessToken.getRefreshExpiresIn(), accessToken.getExpiresIn());
    }
    ...
    public void when_refresh_expires_in_not_empty_with_predefined_refresh_token_true_use_that_value() throws Exception {
        ...
        // THEN
        assertEquals(accessToken.getRefreshExpiresIn(), "1800");
    }
    ...
    public void load_access_token_from_string_map_without_refresh_expires_in() throws Exception {
        ...
        // THEN
        assertEquals(accessToken.getExpiresIn(), accessToken.getRefreshExpiresIn());
    }
